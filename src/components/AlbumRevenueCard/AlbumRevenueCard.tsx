    ...
    return (
        <ScrollXContainer>
                {Array.from(Array(10).keys()).map((index) => (
                    <div style={{display:`flex`, flexDirection:`column`, width:`360px`,height:`296px`,backgroundColor:`#1F2228`,borderRadius:`16px`,padding:`12px`}}>
                        ...
                        <div style={{display:`flex`,flexDirection:`column`,padding:`16px`}}>
                            <div style={{display:`flex`,flexDirection:`row`, justifyContent:`space-between`}}>
                                <p className="text-sm font-['Aileron'] leading-[22px] text-white">Royalties</p>
                                <p className="text-sm font-['Aileron'] leading-[22px] text-white">CHT 50,355.35</p>
                            </div>
                            <div style={{display:`flex`,flexDirection:`row`, justifyContent:`space-between`}}>
                                <p className="text-sm font-['Aileron'] leading-[22px] text-white">NFTs</p>
                                <p className="text-sm font-['Aileron'] leading-[22px] text-white">CHT 50,355.35</p>
                            </div>
                            <div style={{display:`flex`,flexDirection:`row`, justifyContent:`space-between`,width:`310px`,height:`48px`,borderRadius:`24px`,border:`1px solid rgba(255, 255, 255, 0.10)`,padding:`18px`,alignItems:`center`,margin:`8px 0`, backgroundColor:`rgba(28, 30, 34, 0.33)`}}>
                                <p className="text-sm font-['Aileron'] leading-[22px] text-white">Manage Releases</p>
                                <img
