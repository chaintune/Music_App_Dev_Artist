    ...
    <>
        <div className='h-[376px] w-[1440px] bg-orange-600 mx-auto relative'>
            ...
            <NextImage src={star} alt="" width={160} height={160} />
                <div className='mx-8'>
                    <div className="text-white text-5xl font-light font-['Aileron'] leading-[56px] mb-2">Flume</div>
                    ...
                    <div className="text-white text-xs font-normal font-['Aileron'] leading-tight">172,494 Monthly Listeners</div>
